...
Исходники и зависимости разработки OpenClaw обновлены до `2026.9.2+clawx.8`. Рабочий bridge создаёт отдельную сессию в памяти для каждого Run из общей SQLite-истории; адаптированы настройки Agents, моделей, прав и 7 плагинов Channels. Изолированные проверки настоящих Gateway/ACP и собранного payload покрывают инструменты, отмену, восстановление после сбоя и отказ во входящем сообщении без записи native-истории. Установленным ядрам нужен новый проверенный CI-артефакт. Подписание и публикация для 5 платформ, а также проверки реальных аккаунтов ещё не выполнены. См. [дизайн и результаты](harness/reference/openclaw-2026.9.2-upgrade.md).
