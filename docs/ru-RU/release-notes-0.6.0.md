...
- DeepSeek Harness `0.1.2-alpha.2+clawx.10` добавлен вторым optional kernel; оба могут работать одновременно и независимо обновляться, завершаться с ошибкой и откатываться.
