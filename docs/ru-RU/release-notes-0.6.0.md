...
- DeepSeek Harness `0.1.3-alpha.1+clawx.12` добавлен вторым optional kernel; оба могут работать одновременно и независимо обновляться, завершаться с ошибкой и откатываться.
