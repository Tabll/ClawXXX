...
function App() {
  ...
  const macOSNativeFontSmoothing = useSettingsStore((state) => state.macOSNativeFontSmoothing);
  ...
  // Apply global appearance preferences.
  useEffect(() => {
    applyAppAppearance({
      appFontFamily,
      macOSNativeFontSmoothing: window.electron.platform === 'darwin' && macOSNativeFontSmoothing,
      themeColor,
    });
  }, [appFontFamily, macOSNativeFontSmoothing, themeColor]);
      ...
      <TooltipProvider delayDuration={300}>
        <Routes>
          ...
          <Route element={<MainLayout />}>
            ...
            <Route path="/models" element={<Navigate to="/settings/tokenUsage" replace />} />
            <Route path="/agents" element={<Agents />} />
            <Route path="/channels" element={<Channels />} />
            <Route path="/skills" element={<Skills />} />
            <Route path="/cron" element={<Cron />} />
            <Route path="/image-generation" element={<Navigate to="/settings/models" replace />} />
            <Route path="/embeddings" element={<Navigate to="/settings/models" replace />} />
