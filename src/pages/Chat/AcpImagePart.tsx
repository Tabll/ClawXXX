...
export function AcpImagePart({ part, className }: { part: ImageRenderPart; className?: string }) {
  ...
  return (
    <figure
      data-testid="acp-image-part"
      className={cn(
        'group/acp-image relative inline-flex min-h-12 min-w-20 w-fit max-w-full items-center justify-center overflow-hidden rounded-xl border border-black/10 bg-black/5 dark:border-white/10 dark:bg-white/10',
        className,
      )}
    >
      <img
