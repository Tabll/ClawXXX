...
import { cleanupBundle } from './openclaw-bundle-cleanup.mjs';
...
// Platform-specific cleanup (e.g. Koffi binaries) is handled by the optional
// runtime pipeline's prune-native-payload.mjs before sealing.
