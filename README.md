...
**Settings → Token Usage** shows transcript-based token, cost, model, provider, agent, and session usage with interactive charts, session-level recent usage rows, and detailed per-session drilldowns including system prompt context weight.
