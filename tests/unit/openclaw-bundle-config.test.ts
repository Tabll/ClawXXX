...
describe('openclaw bundle config', () => {
  it('pins the OpenClaw 2026.9.4 runtime compatibility matrix', () => {
    ...
    expect(packageJson.devDependencies).toMatchObject({
      openclaw: '2026.9.4',
      electron: '43.4.0',
      '@openclaw/discord': '2026.9.4',
      '@openclaw/qqbot': '2026.7.1',
      '@openclaw/whatsapp': '2026.9.4',
  ...
  it('does not retain superseded channel plugin packages in the lockfile', () => {
    ...
    expect(lockfile).toContain("'@openclaw/ai@2026.9.4':");
  });
